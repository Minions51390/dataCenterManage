...
const WordQuizDetail: React.FC = () => {
    ...
    // 新增单词小测，参数val类型需根据实际情况确定，这里暂未细化
    ...
    /** 页数更改函数，参数val类型需根据实际分页组件要求确定，这里暂未细化 */
            ...
            <div className={style['header']}>
                ...
                <div className={style['header-content']}>
                    <div className={style['header-content-box']}>
                        <div className={style['header-content-text']}>创建人：<span>{wordDetail.creator}</span></div>
                        <div className={style['header-content-text']}>发布时间：<span>{wordDetail.startTime}</span></div>
                    </div>
                    <div className={style['header-content-box']}>
                        <div className={style['header-content-text']}>单词来源：<span>{wordDetail.wordOriginDic}</span></div>
                        <div className={style['header-content-text']}>截止时间：<span>{wordDetail.endTime}</span></div>
                    </div>
                    <div className={style['header-content-box']}>
                        <div className={style['sp']}>试卷题数</div>
                        <div className={style['hard']}>{wordDetail.count}个</div>
                    </div>
                </div>
            </div>
